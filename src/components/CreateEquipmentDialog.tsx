...
import type { Equipment } from "@/lib/shared-schema";
...
export function CreateEquipmentDialog({
  ...
  useEffect(() => {
    if (editItem) {
      ...
      setImagePreview(""); // Equipment schema doesn't have imageUrl property
      setImageFile(null);
    }
  }, [editItem]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editItem) {
      ...
      // Remove image upload - Equipment schema doesn't support images
